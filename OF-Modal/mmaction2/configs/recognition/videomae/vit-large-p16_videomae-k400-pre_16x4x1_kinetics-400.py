...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=38, val_begin=16, val_interval=2)
...
work_dir = '/root/autodl-tmp/output/videomae_large'
# load_from = '/root/autodl-tmp/pretrained/vit_l_hybrid_pt_800e_ssv2_ft_mmversion.pth'
