...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            '/root/autodl-tmp/pretrained/uniformerv2-base-p16-res224_clip-pre_u8_kinetics710-rgb_20221219-77d34f81.pth',  # noqa: E501
            prefix='backbone.')),
    cls_head=dict(
        type='UniFormerHead',
        dropout_ratio=0.4,
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=40, val_begin=16, val_interval=1)
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type='AdamW', lr=1e-4, betas=(0.9, 0.999), weight_decay=1e-2),
...
work_dir = '/root/autodl-tmp/output/uniformerv2_base'
