...
model = dict(
    backbone=dict(
        ...
        pretrained2d=False,
        weight_path = '/root/mmaction2/weights/swin_base_patch244_window1677_sthv2.pth',
        window_size=(16,7,7),
    ),
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=40, val_begin=41, val_interval=1)
...
work_dir = '/root/autodl-tmp/output/swin_base_ssv2_aug_i3ddoubleframe_se_crop_addval'
