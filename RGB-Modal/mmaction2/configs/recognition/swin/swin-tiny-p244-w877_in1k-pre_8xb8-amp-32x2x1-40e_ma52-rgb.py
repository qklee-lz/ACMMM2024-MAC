...
model = dict(
    backbone=dict(
        ...
        '',  # noqa: E501
        pretrained2d=False,
        weight_path = '/root/MAC_2024_baseline/MAR/mmaction2/weights/swin_tiny_patch244_window877_kinetics400_1k.pth'
    ))
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=40, val_begin=30, val_interval=1)
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type='AdamW', lr=2e-4, betas=(0.9, 0.999), weight_decay=1e-2),
...
work_dir = '/root/autodl-tmp/output/swin_tiny'
