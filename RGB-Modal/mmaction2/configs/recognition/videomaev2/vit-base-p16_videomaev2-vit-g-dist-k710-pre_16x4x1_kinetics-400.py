...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=38, val_begin=16, val_interval=1)
...
work_dir = '/root/autodl-tmp/output/videomae_base'
load_from = '/root/autodl-tmp/pretrained/videomae_base_pretrain1m_mmversion.pth'
