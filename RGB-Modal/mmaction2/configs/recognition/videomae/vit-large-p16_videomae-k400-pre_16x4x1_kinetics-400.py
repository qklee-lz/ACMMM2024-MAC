...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=38, val_begin=1, val_interval=2)
...
work_dir = '/root/autodl-tmp/output/videomae_large_k700_trainval_crop'

load_from = '/root/autodl-tmp/pretrained/vit_l_hybrid_pt_800e_k700_ft_mmv.pth'_base_ = ['../../_base_/default_runtime.py']
...
load_from = '/root/autodl-tmp/pretrained/vit_l_hybrid_pt_800e_k700_ft_mmv.pth'